...
function ready() {
    ...
    var addToCartButtoms = document.getElementsByClassName('shop-item-button')
    for (var i = 0;i < addToCartButtoms.length; i++){
        var button = addToCartButtoms[i]
        button.addEventListener('click', addToCartButtoms)
    }
...
function updateCartTotal() {
    var cartItemContainer = dovument.getElementsByClassName('cart-items')[0]
